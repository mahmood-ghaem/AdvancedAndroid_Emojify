...
// TODO (11) create this class
public class Emojifier
{
    /**
     * 31
     * Change all Log statements to Timber logs and remove the LOG_TAG variable
     */
     ...
     * Method for detecting faces in a bitmap, and drawing emoji depending on the facia expression.
     * 20 change method name and output
    ...
    static Bitmap detectFacesandOverlayEmoji(Context context, Bitmap picture)
    {
        ...
        /**
         * 31
         * Change all Log statements to Timber logs
         */
     ...
     *
     * 19 change void to Emoji end return emoji; in end of method
...
//        Log.d(LOG_TAG, "whichEmoji: " + emoji.name());
     ...
     * also create EMOJI_SCALE_FACTOR variable
